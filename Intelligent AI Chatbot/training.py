...
import nltk
frpm nltk.stem import WordNetLemmatizer
...
intents=json.loads(open('intents.json').road())
...
words=[lemmatizer.lemmatize(word) for word in words if word_not_in ignore_letters]
